  ...
  return (
    <S.Wrapper>
      <S.SectionDescription>
        <S.Logo viewBox="0 0 622 186" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <S.Description>
          ...
          <S.Image>
            <Image src="/img/doggo.png" width={448} height={252} />
          </S.Image>
        </S.Description>
      </S.SectionDescription>
      ...
      <S.SectionSummary>
        ...
        <S.ProductImages>
          {items.map(({ id, image }) => (
            <Image key={id} src={image} width={64} height={64} loading="lazy" />
          ))}
        </S.ProductImages>
